...
public class UpdateFulfillHtlcPayloadSerializer : IPayloadTypeSerializer<UpdateFulfillHtlcPayload>
{
    ...
    public async Task<UpdateFulfillHtlcPayload?> DeserializeAsync(Stream stream)
    {
        ...
        try
        {
            ...
            var paymentPreimage = new byte[CryptoConstants.SHA256_HASH_LEN];
