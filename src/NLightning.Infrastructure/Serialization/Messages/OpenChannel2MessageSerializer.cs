...
public class OpenChannel2MessageSerializer : IMessageTypeSerializer<OpenChannel2Message>
{
    private readonly IPayloadSerializer _payloadSerializer;
    
    public OpenChannel2MessageSerializer(IPayloadSerializer payloadSerializer)
    {
    ...
    public async Task<OpenChannel2Message> DeserializeAsync(Stream stream)
    {
        ...
        {
            // Deserialize payload
            var payload = await _payloadSerializer.DeserializeAsync<OpenChannel2Payload>(stream);
