...
public class FeeService : IFeeService
{
    ...
    {
        // Never allow the task to exist more than once
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        // If cache from the file is not valid, refresh immediately
        if (!IsCacheValid())
        {
    ...
    public async Task<LightningMoney> GetFeeRatePerKwAsync(CancellationToken cancellationToken = default)
    {
        ...
        using var linkedCts = CancellationTokenSource
            .CreateLinkedTokenSource(cancellationToken, s_cts?.Token ?? CancellationToken.None);
