...
public sealed class CommitmentNumber
{
    ...
    /// </summary>
    public CommitmentNumber(PubKey localPaymentBasepoint, PubKey remotePaymentBasepoint, ISha256 sha256,
    ...
    private static ulong CalculateObscuringFactor(PubKey localBasepoint, PubKey remoteBasepoint, ISha256 sha256)
    {
