...
internal static partial class Libsodium
{
	...
	[LibraryImport(Name)]
	[UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
	public static partial int crypto_aead_aes256gcm_encrypt(
		ref byte c,
		out long clen_p,
		ref byte m,
		long mlen,
	...
	[LibraryImport(Name)]
	[UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
	public static partial int crypto_aead_aes256gcm_decrypt(
		ref byte m,
		out long mlen_p,
		IntPtr nsec,
		ref byte c,
	...
	[LibraryImport(Name)]
	[UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl)])]
	public static partial int crypto_scalarmult_curve25519_base(
		byte[] q,
		byte[] n
	);
