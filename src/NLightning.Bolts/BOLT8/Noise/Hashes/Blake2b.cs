...
/// </summary>
internal sealed class Blake2b : IHash
{
	...
	public void GetHashAndReset(Span<byte> hash)
	{
		...
		_ = Libsodium.crypto_generichash_blake2b_final(
			aligned,
	...
	private void Reset()
	{
		_ = Libsodium.crypto_generichash_blake2b_init(aligned, null, UIntPtr.Zero, (UIntPtr)HashLen);
	}
