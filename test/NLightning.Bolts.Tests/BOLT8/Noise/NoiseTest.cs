...
public class NoiseTest
{
	...
	[Fact] public void TestCacophony() => Test("BOLT8/Noise/Vectors/cacophony.txt");
	[Fact] public void TestMultipsk() => Test("BOLT8/Noise/Vectors/snow-multipsk.txt");
	...
	private static void Test(string file)
	{
		...
		foreach (var vector in json["vectors"]!)
		{
			...
			setDh.Invoke(init, [new FixedKeyDh(initEphemeral)]);
			setDh.Invoke(resp, [new FixedKeyDh(respEphemeral)]);
