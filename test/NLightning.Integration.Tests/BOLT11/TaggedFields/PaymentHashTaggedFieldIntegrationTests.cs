...
public class PaymentHashTaggedFieldIntegrationTests
{
    ...
    private static (byte[] Buffer, int FieldOffsetBits) BuildBuffer(int prePadBits, int postPadBits)
    {
        ...
        var field = new PaymentHashTaggedField(s_knownHash);
    ...
    public void FromBitReader_Reads_From_Beginning_Of_Buffer()
    {
        ...
        // Act
        var parsed = PaymentHashTaggedField.FromBitReader(reader, TaggedFieldConstants.HashLength);
