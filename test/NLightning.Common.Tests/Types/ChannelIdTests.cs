...
public class ChannelIdTests
{
    ...
    public async Task Given_ValidChannelId_When_SerializedAndDeserialized_Then_DataIsPreserved()
    {
        ...
        // When
        await channelId.SerializeAsync(memoryStream);
        memoryStream.Seek(0, SeekOrigin.Begin);
        var deserializedChannelId = await ChannelId.DeserializeAsync(memoryStream);
    ...
    public async Task Given_InvalidStream_When_Deserialized_Then_ThrowsEndOfStreamException()
    {
        ...
        // When & Then
        await Assert.ThrowsAsync<EndOfStreamException>(async () => await ChannelId.DeserializeAsync(memoryStream));
    }
