...
public class PeerTests
{
    ...
    private static readonly MessageFactory s_messageFactory = new(Microsoft.Extensions.Options.Options.Create(s_nodeOptions));
    ...
    public void Given_InboundPeer_When_ReceivingIncompatibleChain_Then_Disconnects()
    {
        ...
        var otherMessageFactory = new MessageFactory(Microsoft.Extensions.Options.Options.Create(otherNodeOptions));
